...
def single_gpu_test(model,
    ...
    for i, data in enumerate(data_loader):
        # generate calibrate data flag
        if model.module.test_cfg.get('generate_calibrate_data', False):
            model.module.test_cfg["save_calibrate_data_flag"] = False
            data_nums = 20
            if i % (len(data_loader) // data_nums) == 0:
                model.module.test_cfg["save_calibrate_data_flag"] = True
                model.module.test_cfg["calibrate_data_id"] = i
        ...
        if show:
            show_counter += 1
            dataset.show(result, f'./show_dir_debug/{show_counter}')
