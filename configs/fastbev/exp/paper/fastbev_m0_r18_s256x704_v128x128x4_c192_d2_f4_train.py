...
test_pipeline = [
    ...
    dict(type='Collect3D', keys=['img', 'vis_info', 'gt_bboxes_3d', 'gt_labels_3d', 'ego_vel',
                                 'ego2cam', 'intrinsic', 'bev_map'])]

data = dict(
    samples_per_gpu=batch_size if not local_mode else 2,
    ...
    train=dict(
        ...
        ann_file=['/data1/ziyi/qirui_train.lmdb',
                  '/data1/ziyi/qirui_train2.lmdb'] if not local_mode else '/data1/ziyi/qirui_train.lmdb',
        load_interval=1,
        sequential=seq,
        n_times=n_time,
        train_adj_ids=[3,2,1],
    ...
    val=dict(
        ...
        with_box2d=True,
        box_type_3d='LiDAR',
        ann_file='/root/ziyi/fastbev/data/qirui_test.pkl' if not local_mode else '/data1/ziyi/waymo.lmdb',
        load_interval=1,
        sequential=seq,
        n_times=n_time,
        train_adj_ids=[1, 3, 5],
...
load_from = '/root/ziyi/fastbev/work_dirs/0418/epoch_10.pth'
resume_from = None
