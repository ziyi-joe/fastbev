...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, default='/data1/minjie.chang/bst_demo/product/project_demo/fastBev/train/fastbev/ckpts/epoch15_batch4_lr0002.pth', help='checkpoint file')
    parser.add_argument('--out', type=str, default='./output_debug/result.pkl', help='output result file in pickle format')
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
    ...
    parser.add_argument(
        '--show-dir', type=str, default='./show_dir_origin', help='directory where results will be saved')
    parser.add_argument(
        '--gpu-collect',
        action='store_true',
    ...
    parser.add_argument(
        ...
        nargs='+',
        action=DictAction,
        default={'jsonfile_prefix': './output_debug'},
        help='custom options for evaluation, the key-value pair in xxx=yyy '
