...
def parse_args():
    ...
    parser.add_argument('--backbone_onnx_path', default=None, type=str, help='output result file in pickle format')
    parser.add_argument('--head_onnx_path', default=None, type=str, help='output result file in pickle format')
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
