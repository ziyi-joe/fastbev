...
def main():
    ...
    # use pth to generate calibrate data
    cfg.model.test_cfg["test_mode"] = "test_pth"
    cfg.model.test_cfg["generate_calibrate_data"] = True
    backbone_data_path = os.path.join(os.getcwd(), "compiler/backbone_calibrate_data")
    head_data_path = os.path.join(os.getcwd(), "compiler/head_calibrate_data")
